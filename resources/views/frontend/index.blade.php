...
@section('master')
@include('frontend.body.home_slider')
<!--End hero slider-->
@include('frontend.body.home_features_category')
<!--End category slider-->
@include('frontend.body.home_banner')
<!--End banners-->
@include('frontend.body.home_new_product')
<!--Products Tabs-->
@include('frontend.body.home_features_product')
...
<!--End 4 columns-->
@include('frontend.body.home_vendor_list')
<!--Vendor List -->
